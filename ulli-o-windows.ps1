...
echo "Would you like to install rEFInd boot manager as well? PLEASE BE AWARE THAT YOU MUST DISABLE SECURE BOOT IN THE BIOS TO BOOT USING THIS OPTION"

Do {

	$option2 = Read-Host -Prompt "Type y or n for yes or no, then hit enter"

}

Until ($option2 -eq 'y' -or $option2 -eq 'n' )
